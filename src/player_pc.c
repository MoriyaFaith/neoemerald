...
static void Task_DrawPlayerPcTopMenu(u8 taskId)
{
    ...
    windowTemplate.width = GetMaxWidthInSubsetOfMenuTable(sMenuActions_TopMenu, sItemOrder, sTopMenuItemCount);
    tWindowId = AddWindow(&windowTemplate);
    SetStandardWindowBorderStyle(tWindowId, 0);
    PrintMenuActionTexts(tWindowId, 2, GetMenuCursorDimensionByFont(2, 0), 2, GetFontAttribute(2, FONTATTR_LETTER_SPACING), 16, sTopMenuItemCount, sMenuActions_TopMenu, sItemOrder);
    InitMenuInUpperLeftCornerNormal(tWindowId, sTopMenuItemCount, 0);
...
static void Task_CreateItemStorageSubmenu(u8 taskId, u8 cursorPos)
{
    ...
    PrintMenuActionTextsAtPos(tWindowId, 2, GetMenuCursorDimensionByFont(2, 0), 2, 16, 3, sMenuActions_ItemPc);
    InitMenuInUpperLeftCornerNormal(tWindowId, 3, cursorPos);
    ScheduleBgCopyTilemapToVram(0);
...
static void Task_DrawMailSubmenu(u8 taskId)
{
    ...
    PrintMenuActionTextsAtPos(windowId, 2, GetMenuCursorDimensionByFont(2, 0), 2, 16, 4, gMenuActions_MailSubmenu);
