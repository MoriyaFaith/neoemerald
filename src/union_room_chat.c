...
static void DrawTextEntryMessage(u16 x, u8 *str, u8 bgColor, u8 fgColor, u8 shadowColor)
{
    ...
    AddTextPrinterParameterized3(WIN_TEXT_ENTRY, FONT_FRLG, x * 8, 1, color, TEXT_SKIP_DRAW, strBuffer);
}
...
static void ShowKeyboardSwapMenu(void)
{
    ...
    PrintMenuActionTextsAtPos(WIN_SWAP_MENU, FONT_FRLG, 8, 1, 14, ARRAY_COUNT(sKeyboardPageTitleTexts), sKeyboardPageTitleTexts);
    InitMenuNormal(WIN_SWAP_MENU, FONT_FRLG, 0, 1, 14, 5, GetCurrentKeyboardPage());
...
static void PrintChatMessage(u16 row, u8 *str, u8 colorIdx)
{
    ...
    AddTextPrinterParameterized3(WIN_CHAT_HISTORY, FONT_FRLG, 0, row * 15 + 1, color, TEXT_SKIP_DRAW, str);
}
