...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
	...
	// Pokémon from here onwards are UNSEEN in the HoennDex.
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
	    ...
	    [SPECIES_KAKUNA - 1]      = ANIM_GLOW_YELLOW,
	    ...
	    [SPECIES_NIDORINA - 1]    = ANIM_V_SQUISH_AND_BOUNCE,
	    ...
	    [SPECIES_GOLEM - 1]       = ANIM_SWING_CONCAVE_FAST_SHORT,
	    ...
	    [SPECIES_TOTODILE - 1]    = ANIM_H_SHAKE_SLOW,
	    ...
	    [SPECIES_HERACROSS - 1]   = ANIM_H_SHAKE_FAST,
        ...
        [SPECIES_ROSERADE - 1]    = ANIM_H_SHAKE,
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_H_BRENDAN] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_HeliodorBrendan,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_H_MAY] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_HeliodorMay,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (type == TYPE_FIRE && attacker->ability == ABILITY_BLAZE && attacker->hp <= (attacker->maxHP / 3))
        gBattleMovePower = (150 * gBattleMovePower) / 100;
    if (type == TYPE_FIRE && attacker->ability == ABILITY_MOLTEN_CORE)
        gBattleMovePower = (120 * gBattleMovePower) / 100; //20% passive fire boost
