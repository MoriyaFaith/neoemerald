...
const u32 gItemIcon_CampGear[] = INCBIN_U32("graphics/items/icons/camp_gear.4bpp.lz");
const u32 gItemIconPalette_CampGear[] = INCBIN_U32("graphics/items/icon_palettes/camp_gear.gbapal.lz");
