...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_EM_BRENDAN] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_EM_MAY] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_H_BRENDAN] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_H_MAY] = TRAINER_CLASS_RIVAL,
