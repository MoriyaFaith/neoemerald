const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]     = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_CROBAT}},
    ...
    [SPECIES_VENONAT]    = {{EVO_LEVEL, 26, SPECIES_VENOMOTH}},
    ...
    [SPECIES_CHANSEY]    = {{EVO_FRIENDSHIP_DAY, 0, SPECIES_BLISSEY}},
    ...
    [SPECIES_LEDYBA]     = {{EVO_LEVEL, 12, SPECIES_LEDIAN}},
    [SPECIES_SPINARAK]   = {{EVO_LEVEL, 12, SPECIES_ARIADOS}},
    ...
    [SPECIES_RALTS]      = {{EVO_LEVEL, 15, SPECIES_KIRLIA}},
