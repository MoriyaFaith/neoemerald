const struct Trainer gTrainers[] = {
    ...
    [TRAINER_NORMAN_1] =
    {
        .partyFlags = F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_CUSTOM_ABILITY,
        .trainerClass = TRAINER_CLASS_LEADER,
        .encounterMusic_gender = TRAINER_ENCOUNTER_MUSIC_MALE,
        ...
        .party = {.ItemCustomMovesAbilities = sParty_Norman1},
    },
    ...
    [TRAINER_WINONA_1] =
    {
        ...
        .party = {.ItemCustomMovesAbilities = sParty_Winona1},
    },
    ...
    [TRAINER_WALLY_PETALBURG] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .partySize = ARRAY_COUNT(sParty_WallyPetalburg),
        .party = {.NoItemDefaultMoves = sParty_WallyPetalburg},
        .hasCustomTransition = TRUE,
        .transition = B_TRANSITION_MUGSHOT,
    },
    ...
    [TRAINER_BLART] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE,
        .partySize = ARRAY_COUNT(sParty_Blart),
        .party = {.NoItemDefaultMoves = sParty_Blart},
    },
    ...
    [TRAINER_GERSON] =
    {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE,
        .partySize = ARRAY_COUNT(sParty_Gerson),
        .party = {.NoItemDefaultMoves = sParty_Gerson},
    },
};
