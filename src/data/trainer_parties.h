...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
	{
		...
		.heldItem = ITEM_NONE,
		.moves = {MOVE_SWORDS_DANCE, MOVE_AGILITY, MOVE_X_SCISSOR, MOVE_BATON_PASS}
	},
	{
	    .iv = 255,
	    .lvl = 32,
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_FLAMETHROWER, MOVE_PSYCHIC, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 32,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_WING_ATTACK, MOVE_BITE, MOVE_NONE}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_RECOVER, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 32,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RECOVER, MOVE_EXTRASENSORY, MOVE_KARATE_CHOP, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .species = SPECIES_GRAVELER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULK_UP, MOVE_EXPLOSION, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
	...
	.heldItem = ITEM_NONE,
	.moves = {MOVE_IRON_DEFENSE, MOVE_IRON_HEAD, MOVE_ROCK_SLIDE, MOVE_NONE}
	}
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_MACHOKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULK_UP, MOVE_STRENGTH, MOVE_NONE, MOVE_NONE}
    },
    {
	.iv = 255,
	.lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_BLOCK, MOVE_THUNDER_WAVE, MOVE_SPARK, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SMASH, MOVE_ROCK_THROW, MOVE_DEFENSE_CURL, MOVE_MUD_SPORT}
    },
    {
    .iv = 100,
    .lvl = 17,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_BULK_UP, MOVE_SILVER_WIND, MOVE_BATON_PASS}
    },
    {
    .iv = 200,
    .lvl = 19,
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SMELLING_SALT, MOVE_VITAL_THROW, MOVE_REVERSAL, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_VOLTORB,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_SCREECH, MOVE_SELF_DESTRUCT, MOVE_SPARK}
    },
    {
    .iv = 220,
    .lvl = 22,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_SOUND, MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_TRI_ATTACK}
    },
    {
    .iv = 200,
    .lvl = 23,
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_SEISMIC_TOSS, MOVE_DIG}
    },
    {
    .iv = 250,
    .lvl = 24,
    ...
    .moves = {MOVE_BITE, MOVE_THUNDER_WAVE, MOVE_THUNDER_FANG, MOVE_HOWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER, MOVE_EARTH_POWER, MOVE_OVERHEAT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 250,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Norman1[] = {
    {
    .iv = 200,
    .lvl = 30,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_LEFTOVERS,
	.moves = {MOVE_RAZOR_WIND, MOVE_STEEL_WING, MOVE_SPIKES, MOVE_IRON_DEFENSE},
	.abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_FACADE, MOVE_ROCK_SLIDE, MOVE_ROCK_SMASH},
	.abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_THUNDERBOLT, MOVE_CONFUSE_RAY, MOVE_SUBSTITUTE},
	.abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .species = SPECIES_HERACROSS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGAHORN, MOVE_SUBMISSION, MOVE_SWORDS_DANCE, MOVE_FACADE},
	.abilityNums = 1,
    },
    {
    .iv = 250,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_SWIFT, MOVE_SAND_ATTACK, MOVE_GROWL, MOVE_SECRET_POWER}
    },
    {
    .iv = 150,
    .lvl = 18,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 20,
    .species = SPECIES_SCYTHER,
    .moves = {MOVE_FURY_CUTTER, MOVE_SLASH, MOVE_WING_ATTACK, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 27,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_KARATE_CHOP, MOVE_DETECT, MOVE_CONFUSION, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyJaggedPass[] = {
    ...
    .lvl = 25,
    .species = SPECIES_SWABLU,
    .moves = {MOVE_AERIAL_ACE, MOVE_SAFEGUARD, MOVE_SECRET_POWER, MOVE_SING}
    },
    {
    .iv = 100,
    .lvl = 27,
    .species = SPECIES_KIRLIA,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_PSYCHIC, MOVE_SHOCK_WAVE, MOVE_CALM_MIND}
    }
};
