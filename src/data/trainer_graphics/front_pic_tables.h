const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ACE_TRAINER_M] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_ACE_TRAINER_F] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ACE_TRAINER_M, gTrainerFrontPic_CoolTrainerM, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(ACE_TRAINER_F, gTrainerFrontPic_CoolTrainerF, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(EM_BRENDAN, gTrainerFrontPic_EmeraldBrendan, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(EM_MAY, gTrainerFrontPic_EmeraldMay, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(H_BRENDAN, gTrainerFrontPic_HeliodorBrendan, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(H_MAY, gTrainerFrontPic_HeliodorMay, TRAINER_PIC_SIZE),
