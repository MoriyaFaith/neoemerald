...
const struct CompressedSpriteSheet gTrainerBackPicTable[] =
{
    ...
    [TRAINER_BACK_PIC_EM_BRENDAN] = {
        .data = (const u32 *)gTrainerBackPic_EmeraldBrendan,
        .size = TRAINER_PIC_SIZE * ARRAY_COUNT(gTrainerBackPicTable_EmeraldBrendan),
        .tag = TRAINER_BACK_PIC_EM_BRENDAN,
    },
    [TRAINER_BACK_PIC_EM_MAY] = {
        .data = (const u32 *)gTrainerBackPic_EmeraldMay,
        .size = TRAINER_PIC_SIZE * ARRAY_COUNT(gTrainerBackPicTable_EmeraldMay),
        .tag = TRAINER_BACK_PIC_EM_MAY,
    },
    [TRAINER_BACK_PIC_H_BRENDAN] = {
        .data = (const u32 *)gTrainerBackPic_HeliodorBrendan,
        .size = TRAINER_PIC_SIZE * ARRAY_COUNT(gTrainerBackPicTable_HeliodorBrendan),
        .tag = TRAINER_BACK_PIC_H_BRENDAN,
    },
    [TRAINER_BACK_PIC_H_MAY] = {
        .data = (const u32 *)gTrainerBackPic_HeliodorMay,
        .size = TRAINER_PIC_SIZE * ARRAY_COUNT(gTrainerBackPicTable_HeliodorMay),
        .tag = TRAINER_BACK_PIC_H_MAY,
    },
