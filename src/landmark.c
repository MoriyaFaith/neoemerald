...
static const u8 LandmarkName_MrBrineysCottage[] = _("BRINEY'S COTTAGE");
...
static const u8 LandmarkName_OldLadysRestShop[] = _("REST STOP");
static const u8 LandmarkName_Desert[] = _("DESERT");
static const u8 LandmarkName_WinstrateFamily[] = _("WINSTRATE FAMILY");
...
static const u8 LandmarkName_TunnelersRestHouse[] = _("RESTHOUSE");
static const u8 LandmarkName_RusturfTunnel[] = _("RUSTURF TUNNEL");
static const u8 LandmarkName_PokemonDayCare[] = _("DAY CARE");
static const u8 LandmarkName_SafariZoneEntrance[] = _("SAFARI ZONE");
...
static const u8 LandmarkName_BerryMastersHouse[] = _("BERRY MASTER");
...
static const u8 LandmarkName_FossilManiacsHouse[] = _("FOSSIL MANIAC");
