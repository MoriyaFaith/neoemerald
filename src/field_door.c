...
static const u8 sDoorAnimPalettes_PetalburgGym[] = {6, 6, 6, 6};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_PetalburgGym_Door,                            DOOR_SOUND_NORMAL,  0, sDoorAnimTiles_PetalburgGym, sDoorAnimPalettes_PetalburgGym},
