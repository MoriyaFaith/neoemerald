...
const u8 gText_XNatureSnaggedAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature.\nSnagged by {DYNAMIC 6} at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_5StarWinsStraight[] = _("W:{CLEAR_TO 0x30}S:");
const u8 gText_BattleTower2[] = _("BATTLE TOWER");
const u8 gText_ShinyCount[] = _("ALT. COLOR POKéMON FOUND");
const u8 gText_PowerPoints[] = _("POWER POINTS EARNED");
const u8 gText_NumPowerPoints[] = _("{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}pt");
...
const u8 gText_ButtonTypeNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}DISABLED");
const u8 gText_ButtonTypeLR[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}STANDARD");
