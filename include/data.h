...
#define ITEM_CUSTOM_MOVES_ABILITIES(party) { .ItemCustomMovesAbilities = party }, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_ABILITY
...
union TrainerMonPtr
{
    ...
    const struct TrainerMonItemCustomMovesAbilities *ItemCustomMovesAbilities;
};
...
extern const struct SpriteFrameImage gTrainerBackPicTable_HeliodorBrendan[];
extern const struct SpriteFrameImage gTrainerBackPicTable_HeliodorMay[];
